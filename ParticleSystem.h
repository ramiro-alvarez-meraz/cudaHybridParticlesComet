...
class ParticleSystem
{
    public:
        ...
        void sphereEmitterInit(uint &index, vec3f pos, float r, int n, float lifetime);
        //void sphereEmitter(uint &index, vec3f pos, vec3f vel, vec3f spread, float r, int n, float lifetime, float lifetimeVariance);
        void currentDensity(uint &index, uint3 size, int n, vec3f pos);
